        ...
        >
          ...
          <div className="mb-6 sm:mb-8 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 !bg-primary-100 rounded-full mb-3 sm:mb-4">
              <Rocket className="w-6 h-6 sm:w-8 sm:h-8 !text-primary-600" />
            </div>
          ...
          {/* Summary card */}
          <Card className="mb-4 sm:mb-6 !bg-white !border-neutral-200 !text-neutral-900">
            ...
            <CardContent className="px-4 sm:px-6 pb-4 sm:pb-6">
              {/* Strategy */}
              <div className="mb-3 sm:mb-4 p-2.5 sm:p-3 !bg-neutral-50 rounded-lg !border-neutral-100 border">
                <p className="text-xs sm:text-sm !text-neutral-500 mb-0.5 sm:mb-1">
                  Strategy
                </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4">
                <div className="text-center p-3 sm:p-4 !bg-primary-50 rounded-lg !border-primary-100 border">
                ...
                <div className="text-center p-3 sm:p-4 !bg-emerald-50 rounded-lg !border-emerald-100 border">
            ...
            <CardContent className="px-2 sm:px-6 pb-4 sm:pb-6">
              <div className="!divide-neutral-100 divide-y">
                {selectedCandidates.map((ticket) => (
                  <div
                    key={ticket.id}
                    className="py-3 sm:py-4 px-2 sm:px-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 hover:!bg-neutral-50 rounded-lg transition-colors group"
                  >
                    <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                      <Badge
                        variant="secondary"
                        className="font-mono text-[10px] sm:text-xs !bg-neutral-100 !text-neutral-700 !border-neutral-200 border shrink-0"
                      >
                        {ticket.id}
                      </Badge>
                      <span className="!text-neutral-900 font-medium text-xs sm:text-sm flex-1 min-w-0 truncate group-hover:!text-primary-600 transition-colors">
                        {ticket.title}
                      </span>
                      {refinedTickets[ticket.id] && (
                        <Badge className="!bg-emerald-50 !text-emerald-700 !border-emerald-200 border flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-0.5 shrink-0 shadow-sm">
                          <Check
                    ...
                    <div className="sm:ml-4 shrink-0 self-start sm:self-auto">
                      <span className="text-xs sm:text-sm font-semibold !text-neutral-700 bg-neutral-100 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md">
          ...
          {/* Warnings */}
          {hasWarnings && (
            <Card className="mb-4 sm:mb-6 !border-amber-200 !bg-amber-50 !text-neutral-900">
              <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
                <div className="flex items-start gap-2 sm:gap-3">
                  <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 !text-amber-600 shrink-0 mt-0.5" />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm sm:text-base font-medium !text-amber-800 mb-1.5 sm:mb-2">
                      AI Suggestions Require Confirmation
                    </p>
                    <ul className="text-xs sm:text-sm !text-amber-700 space-y-1 list-disc list-inside mb-3 sm:mb-4">
          ...
          <div className="flex justify-center">
            <Button
              size="lg"
              className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg bg-primary-500 hover:bg-primary-600 w-full sm:w-auto"
              onClick={handleLaunch}
              disabled={!canLaunch || isLaunching}
              aria-label="Launch sprint"
            >
              <Rocket className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" />
              Launch Sprint
            </Button>
          </div>

          {!canLaunch && (
            <p className="text-center text-xs sm:text-sm !text-neutral-500 mt-2 sm:mt-3 px-2">
