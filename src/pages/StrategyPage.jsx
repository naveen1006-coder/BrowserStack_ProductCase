    ...
    <div className="min-h-screen !bg-neutral-50">
      ...
      <header className="!bg-white !border-neutral-200 border-b">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            <LogOut className="w-5 h-5 text-primary-500 hover:text-neutral-400" />
          </button>
        </div>
      </header>
        ...
        >
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="!bg-white !border-neutral-200 !text-neutral-900 shadow-md hover:shadow-lg transition-shadow">
                <CardHeader className="pb-4">
                  <CardTitle className="text-lg font-semibold flex items-center gap-2.5 !text-neutral-900">
                ...
                <CardContent>
                  <Select value={selectedDemo} onValueChange={setSelectedDemo}>
                    <SelectTrigger
                      ...
                      className="!bg-white !border-neutral-300 !text-neutral-900 h-11 hover:!border-primary-400 transition-colors"
                    >
                    ...
                    <SelectContent className="!bg-white !border-neutral-200 !text-neutral-900 shadow-lg">
                      {demoStrategies.map((demo) => (
                        <SelectItem
                          key={demo.id}
                          value={demo.id}
                          className="!text-neutral-900 focus:!bg-primary-50 focus:!text-primary-700"
                        >
                          {demo.name}
                        </SelectItem>
                      ))}
              ...
              <Card className="!bg-white !border-neutral-200 !text-neutral-900 shadow-md hover:shadow-lg transition-shadow">
                <CardHeader className="pb-4">
                  <CardTitle className="text-lg font-semibold flex items-center gap-2.5 !text-neutral-900">
                    <div className="p-1.5 rounded-lg bg-primary-50">
                      <PercentDiamond className="w-5 h-5 text-primary-500" />
                    </div>
                    Sprint Strategy
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <Textarea
                    ...
                    disabled={true}
                    className="min-h-[150px] !bg-white !border-neutral-300 !text-neutral-900 !placeholder:text-neutral-400 disabled:!bg-neutral-100 disabled:!cursor-not-allowed"
            ...
            <div className="space-y-6">
              <Card className="!bg-white !border-neutral-200 !text-neutral-900 shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <Label
                      htmlFor="capacity"
                      className="!text-neutral-700 font-medium mb-2 block"
                    >
                      Capacity Points
                    </Label>
                    <div className="mt-2 flex items-center gap-3">
                      <Input
                        ...
                        className="w-24 !bg-white !border-neutral-300 !text-neutral-900 h-10 focus:!border-primary-500 focus:!ring-2 focus:!ring-primary-100"
                  ...
                  {/* Capacity mode */}
                  <div>
                    <Label className="mb-3 block !text-neutral-700 font-medium">
                      Capacity Mode
                    </Label>
                  ...
                  {/* Tech debt slider */}
                  <div>
                    <Label className="mb-4 block !text-neutral-700 font-medium">
                    ...
                    <div className="mt-3 flex justify-between text-xs !text-neutral-500 font-medium">
                      <span>0%</span>
                      <span>30%</span>
                    </div>
                  </div>
              ...
              {/* Generate button */}
              <Button
                className="w-full h-12 text-base font-semibold shadow-md hover:shadow-lg transition-all disabled:shadow-none"
              ...
              {!canGenerate && (
                <p className="text-xs text-center !text-neutral-500 flex items-center justify-center gap-1.5">
                  ...
                  Enter a strategy (min 10 characters) to continue
                </p>
              )}
            </div>
          </div>
